...
class StoreInvernaderoRequest extends FormRequest
{
    ...
    {
        return [
            'nombre'      => ['required', 'string', 'max:50', 'unique:invernaderos,nombre'],
    ...
    public function messages(): array
    {
        return [
            ...
            'nombre.unique'        => 'Ya existe un invernadero con ese nombre.',
