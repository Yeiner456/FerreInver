...
class CreateProveedorRequest extends FormRequest
{
    ...
    {
        return [
            'nit'      => ['required', 'numeric', 'min:1', 'digits_between:1,11', 'unique:proveedores,nit_proveedor'],
            'correo'   => ['required', 'email', 'max:80', 'unique:proveedores,correo'],
    ...
    {
        return [
            'nit.required'         => 'Todos los campos son obligatorios.',
            'nit.numeric'          => 'El NIT debe ser un número válido de máximo 11 dígitos.',
            'nit.min'              => 'El NIT debe ser un número válido de máximo 11 dígitos.',
            'nit.digits_between'   => 'El NIT debe ser un número válido de máximo 11 dígitos.',
            ...
            'telefono.regex'       => 'Teléfono inválido. Solo números, espacios, guiones, paréntesis y +',
            'telefono.max'         => 'Teléfono inválido. Solo números, espacios, guiones, paréntesis y +',
